...
- Metrics use detected events when tracked frame annotations exist, otherwise they fall back to draft sample summaries; neither path is validated ground truth yet.
