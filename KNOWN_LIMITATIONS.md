...
- Manual skeleton/event annotations and layer visibility are available in the current client state and JSON export, but they are not persisted through IndexedDB yet.
